...
public class OuvintePlaceholder implements FocusListener{
    ...
    public OuvintePlaceholder(JTextField item, String nome, Color corFocada, Color corDesfocada){
        this.txtArea = new JTextArea();
        this.txtArea.setText("none");
        this.item = item;
        this.nome = nome;
    ...
    public OuvintePlaceholder(JTextArea txtArea, String nome, Color corFocada, Color corDesfocada){
        this.item = new JTextField();
        this.item.setText("none");
        this.nome = nome;
        this.txtArea = txtArea;
